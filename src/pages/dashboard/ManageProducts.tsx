  ...
  <table className="min-w-full table-auto border-collapse bg-white rounded-lg shadow-lg">
    ...
    <tbody>
      {data?.data?.map((product: TProducts) => (
        <tr key={product?._id} className="border-t border-gray-300 hover:bg-gray-100 transition">
             <td className="p-4">
          ...
          <td className="p-4 text-center text-gray-700">${product?.price}</td>
          <td className="p-4 text-center">
            <span className={`font-semibold ${product.available ? 'text-green-500' : 'text-red-500'}`}>
